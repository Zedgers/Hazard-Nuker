...
def main():
    setTitle(f"Hazard Nuker {THIS_VERSION} || Advanced version by somebody#2380 || https://discord.gg/3pRHPyhk4N")
    clear()
    global threads
    global cancel_key
...
{Fore.RESET}[{Fore.LIGHTGREEN_EX}3{Fore.RESET}]{Fore.LIGHTGREEN_EX} HypeSquad Balance
        ...
        print(f"{Fore.RED}COMING SOON. . .\n{Fore.RESET}Join their discord (https://cheataway.com) to see what will be here! || Join my discord for updates: https://discord.gg/3pRHPyhk4N")
        sleep(4)
        main()
